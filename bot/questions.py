...
questions.append(question.Question('Есть ли у вас кашель? (0 - кашля нет, 10 - сильный)', 'cough', 'bool', keyboards.range_selector))
...
questions.append(question.Question('Есть ли у вас головная боль? Оцените её по шкале от 0 до 10 (0 - нет совсем, 10 - очень сильная)', 'head_ache', 'bool', keyboards.range_selector))
questions.append(question.Question('Болит ли у вас горло? (0 - не болит совсем, 10 - сильно)', 'sore_throat', 'bool', keyboards.range_selector))
questions.append(question.Question('Ваш возраст - 60 или старше?', 'age_60_and_above', 'bool', keyboards.yes_no))
